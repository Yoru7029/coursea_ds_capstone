...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        filtered_data = filtered_data['class'].value_counts().to_frame().reset_index()
        fig = px.pie(filtered_data, values='count', names='class', title=f'Total Success Launches for site {entered_site}')
...
def get_scatter_plot(entered_site, entered_range):
    ...
    # Make plot
    fig = px.scatter(
        filtered_data, x='Payload Mass (kg)', y='class', 
